    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="6E6E6E">
                                            ...
                                            <div class="Unsubscribe--addressLine"><p class="Unsubscribe--senderName" style="font-size:26px; line-height:20px;"><a href="http://mamurjor.com/" target="_blank">mamurjor</a></p>
<br>
                                              <p style="font-size:12px; line-height:20px;"><span class="Unsubscribe--senderAddress">Dhaka</span>, <span class="Unsubscribe--senderCity">Mirpur</span>, <span class="Unsubscribe--senderState">Astha vaban, 4th floor,</span> <span class="Unsubscribe--senderZip">Zip-code : 1216</span></p></div>
      <tbody>
