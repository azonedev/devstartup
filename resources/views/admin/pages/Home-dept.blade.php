...
@section('main-content')
    <div class="panel panel-primary ">
        ...
        <div class="panel-body">
            <form role="form" action="{{url('admin/home/dept/store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <input type="text" class="form-control" name="link" placeholder="If you don't have link just type #" required>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <label for="title">Button Name</label>
                        <input type="text" class="form-control" name="btn-name" required>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    All department on your web system
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                        ...
                                        <table class="table table-striped table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        <form action="{{url('admin/home/dept/edit')}}/{{$item->id}}" method="post">
                                                            @csrf
                                                    ...
                                                    <td class="center">
                                                        <form action="{{url('admin/home/dept/archrive')}}/{{$item->id}}" method="post">
                                                            @csrf
