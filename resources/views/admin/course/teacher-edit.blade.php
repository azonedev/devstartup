...
@section('main-content')
    <div class="panel panel-primary ">
        <div class="panel-heading">Edit a teacher on system as traning purpose</div> 
        <div class="panel-body">
            @foreach ($singleData as $item)
                
            <form role="form" action="{{url('admin/teacher/update')}}/{{$item->id}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="about" class="form-control" id="" cols="30" rows="10" required>{{$item->about}}</textarea>
                </div>
                ...
                <hr>
                <input type="hidden" value="{{$item->image}}" name="prev_img">
