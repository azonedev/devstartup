    ...
    <div class="panel panel-primary ">
        <div class="panel-body">
            @foreach ($singleCategory as $item)
                <form role="form" action="{{url('admin/video-category/update')}}/{{$item->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control" value="{{$item->category}}" name="category" required>
                        </div>
